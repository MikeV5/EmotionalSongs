/**
 * Fornisce le classi di utilita' necessarie per gestire i diversi oggetti Utente, Playlist, Canzone, Emozione.
 * Include anche la classe {@link util.PasswordHashManager} per la gestione della password.
